      ...
      <section class="envor-section envor-home-slider">
        <div id="layerslider" class="envor-layerslider" style="height: 500px;">
          ...
          <div class="ls-layer" style="transition3d: 1,4,5,11; transition2d: 2,8,30;">
            ...
            <img class="ls-bg" src="img/bg40.jpg" alt="layer1-background">
          </div>
          <!--LayerSlider layer-->
          <div class="ls-layer" style="transition3d: 2,3,6,14; transition2d: 4,5,23;">
            <!--LayerSlider background-->
            <img class="ls-bg" src="img/50.jpg" alt="layer1-background">
          </div>
        </div>
      <!--
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <h2>快叫外卖吧！</h2>
              <p>
            我们是一家移动互联网创业公司，我们是一支拥有丰富的互联网行业经验的创业团队，致力于用户的健康事业，致力于为用户提供优质的用户体验。
              </p>
              <p>
