					...
					<div class="span12">
						<div class="content-widgets light-gray">
						  ...
						  <div class="widget-container">
						   ...
						   <form action="${pageContext.request.contextPath}/admin/project/create" enctype="multipart/form-data" method="post">
							<div class="control-group">
								<label for="title" class="control-label">商品图标：</label>
								<div class="controls">
